...
INSERT INTO user_role (role_id, role_name, role_key, role_description) VALUES (2, 'User', 'VIEW_USER', 'Normal user role');
...
INSERT INTO user_permission (per_id, per_name, per_key, per_description, per_value) VALUES (5, 'View User', 'VIEW_USER', 'Could get own user info and register', 'View User');
INSERT INTO user_permission (per_id, per_name, per_key, per_description, per_value) VALUES (6, 'Create User', 'CREATE_USER', 'Create User', 'Create User');
...
INSERT INTO role_permission_xref (role_id, per_id) VALUES (1, 1);
INSERT INTO role_permission_xref (role_id, per_id) VALUES (1, 2);
INSERT INTO role_permission_xref (role_id, per_id) VALUES (1, 3);
INSERT INTO role_permission_xref (role_id, per_id) VALUES (1, 4);
INSERT INTO role_permission_xref (role_id, per_id) VALUES (2, 1);
INSERT INTO role_permission_xref (role_id, per_id) VALUES (2, 3);
INSERT INTO role_permission_xref (role_id, per_id) VALUES (2, 4);
INSERT INTO role_permission_xref (role_id, per_id) VALUES (3, 1);
